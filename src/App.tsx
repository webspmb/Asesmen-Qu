      ...
      <div className="flex-1 flex flex-col md:flex-row min-h-0 relative">
        ...
        {activeTab === 'tp_settings' && (
          <div className="space-y-6">
            ...
            {/* Setting Bobot (Weighting) */}
            <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-md">
              <h3 className="text-sm md:text-base font-extrabold text-slate-800 mb-2 flex items-center gap-2">
                <Settings className="w-5 h-5 text-blue-600" />
                Bobot Kontribusi Nilai Rapor Akhir
              </h3>
              <p className="text-xs text-slate-400 font-medium mb-5">Sesuaikan persentase konstanta rumus nilai Akhir sesuai kebijakan kriteria sekolah Anda.</p>
